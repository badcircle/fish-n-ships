...
@export var chunkSize = 1000
@export var terrain_height = 35
@export var view_distance = 2001
...
@export_range(1,1000, 1) var LOD0_Distance := 1001
@export_range(1,100, 1) var LOD1 := 75
@export_range(1,1000, 1) var LOD1_Distance := 1100
@export_range(1,100, 1) var LOD2 := 50
@export_range(1,1000, 1) var LOD2_Distance := 1200
@export_range(1,100, 1) var LOD3 := 25
@export_range(1,1000, 1) var LOD3_Distance := 1500
@export_range(1,100, 1) var LOD4 := 10
@export_range(1,1000, 1) var LOD4_Distance := 2000
